...
Shader "FORGE3D/Planets/Sun" 
{
    ...
    CGPROGRAM
        ...
        void surf (Input IN, inout SurfaceOutput o) 
        {
            ...
            float3 color =  pow(r.g, 1.5) * 50;
            float3 color2 = pow(g.r, 1) * 1;
            color = lerp (_Cool * _Cool.a * 100, _Warm * _Warm.a * 100, color) ;
            color2 = lerp (_Hot * _Hot.a * 100, _Hot * _Hot.a * 100, color2) ;
            color *= r.g * 5;
            color += color2 * g.r ;
