    ...
    public class CursorFeedback : MonoBehaviour
    {
        ...
        private Interactible FocusedInteractible
        {
            get
            {
                ...
                {
//                   Debug.Log("InteractibleManager.Instance.FocusedGameObject.GetComponent<Interactible>()");
//                    Debug.Log(InteractibleManager.Instance.FocusedGameObject.GetComponent<Interactible>());
        ...
        private void UpdateScrollDetectedState()
        {
            ...
            {
                bool value1 = CursorManager.Instance == null;
                // Debug.Log("CursorManager.Instance == null "+ value1);
                bool value2 = FocusedInteractible == null;
                // Debug.Log("FocusedInteractible == null "+ value2);
                bool value = GestureManager.Instance.ActiveRecognizer != GestureManager.Instance.NavigationRecognizer;
               // Debug.Log("GestureManager.Instance.ActiveRecognizer != GestureManager.Instance.NavigationRecognize "+ value);
