...
public class NGraphUtils
{
   ...
   public static GameObject AddGameObject(GameObject pParentGo, float zValue, string name)
   {
      GameObject pNewGo = new GameObject(name);
      AddGameObject(pParentGo, pNewGo, zValue);
   ...
   public static GameObject AddGameObject(GameObject pParentGo, GameObject pWillBeChildGo, float zValue)
   {
   ...
   public static void AddMesh(GameObject pGo, out MeshRenderer pMeshRenderer, out Mesh pMesh)
   {
      ...
      pMeshRenderer.castShadows = false;
